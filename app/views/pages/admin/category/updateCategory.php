					...
					<div class="row align-items-center">
						<div class="border-0 mb-4">
							<div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
								<h3 class="fw-bold mb-0">Cập nhập danh mục</h3>
								...
								<div class="card mb-3">
									...
									<div class="card-body">
										<div class="form-check">
											<input class="form-check-input" value="1" id="radio1Public" type="radio" name="status" <?= $dataCate['status'] == 1 ? 'checked' : '' ?>>
											<label for="radio1Public" class="form-check-label">
												Công khai
											</label>
										</div>
										<div class="form-check">
											<input class="form-check-input" value="0" id="radio1Hiden" type="radio" name="status" <?= $dataCate['status'] == 0 ? 'checked' : '' ?>>
								...
								<div class="card-body">
									<div class="row g-3 align-items-center">
										<div class="col-md-6">
											...
											<input type="text" value="<?= $dataCate['name'] ?? '' ?>" name="name" class="form-control">
										</div>
									...
									<div class="mt-4 gap-3 flex-wrap  d-flex">
										...
										<?php } else { ?>
											<div class="position-relative">
												<img class="border p-2" style="width: 150px; display: block; object-fit: contain; border-radius: 10px;" src="<?= $dataCate['image'] ?? '' ?>" alt="<?= $dataCate['name'] ?? '' ?>">
