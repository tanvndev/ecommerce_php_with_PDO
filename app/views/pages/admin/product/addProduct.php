            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="form-input">
                            <div class="mb-5 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control input-text" name="title" type="text" placeholder="Tên sản phẩm">
                                </div>
                            </div>
                            <!--  -->
                            <div class="mb-5 row align-items-center">
                            ...
                            <div class="mb-5 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <select class="select-custom" name="brand_id" id="select-custom2">
                                        ...
                                        ?>
                                            <option value="<?php echo $brandItem['id'] ?>"><?php echo $brandItem['name'] ?></option>
                                        <?php } ?>
                            ...
                            <div class="mb-5 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control input-text" name="weight" type="number" placeholder="Cân nặng">
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="form-input">
                            <div class="mb-5 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control input-text" id="price" type="number" placeholder="Giá sản phẩm">
                                </div>
                            </div>
                            <div class="mb-5 row align-items-center">
                                <label class="form-label-title col-sm-3 mb-0">Giảm giá</label>
                                <div class="col-sm-7">
                                    <input class="form-control input-text" id="discount" value="0" name="discount" type="number" placeholder="Giảm giá">
                                </div>
                                <div class="col-sm-2">
                                    <span>Tối đa: 99%</span>
                                </div>
                            ...
                            <div class="mb-5 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control input-text" id="price_new" value="0" readonly name="price" type="number" placeholder="Thành tiền">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-8 m-auto ">
                    <div class="card">
                        ...
                        <div class="form-input">
                            <div class="mb-5 row">
                                <label class="form-label-title col-sm-2 mb-0">Màu sắc</label>
                                <div class="col-sm-10">
                                    <div class="d-flex flex-wrap gap-4">
                                        ...
                                        ?>
                                            <div class="form-check">
                                                <input class="form-check-input" name="attribute_id[]" type="checkbox" value="<?php echo $color['id'] ?>" id="<?php echo $color['name'] . '_' . $color['value']  ?>">
                            ...
                            <!--  -->
                            <div class="mb-5 row">
                                <label class="form-label-title col-sm-2 mb-0">Dung lượng</label>
                                <div class="col-sm-10">
                                    <div class="d-flex flex-wrap gap-4">
                                        <?php
                                        ...
                                        ?>
                                            <div class="form-check">
                                                <input class="form-check-input" name="attribute_id[]" type="checkbox" value="<?php echo $size['id'] ?>" id="<?php echo $size['name'] . '_' . $size['value']  ?>">
                ...
                <button class="btn btn-custom col-sm-8 m-auto">Add new product</button>
            </div>
        </form>
    </div>
