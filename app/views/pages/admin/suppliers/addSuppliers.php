            ...
            <div class="row align-items-center">
                <div class="border-0 mb-4">
                    <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                        <h3 class="fw-bold mb-0">Thêm nhà cung cấp</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="tel" value="<?= $dataValueOld['phone'] ?? '' ?>" name="phone" class="form-control">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label">Email</label>
                                    <input type="email" name="email" value="<?= $dataValueOld['email'] ?? '' ?>" class="form-control">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label">Địa chỉ</label>
                                    <textarea name="address" class="form-control" cols="30" rows="2"><?= $dataValueOld['address'] ?? '' ?></textarea>
                                </div>
                            </div>
